...
class Game{
    public:
        ...
        void setHandStrenghtJoker(){
            ...
            // 4 of a kind
            else if(find(nrOfCards.begin(), nrOfCards.end(), 4) != nrOfCards.end()){
                value = 40;
            }
            // 3 of a kind
            else if(find(nrOfCards.begin(), nrOfCards.end(), 3) != nrOfCards.end()){
                // full house
                if(find(nrOfCards.begin(), nrOfCards.end(), 2) != nrOfCards.end()){
                    value = 35;
                }
                else{
                    value = 30;
